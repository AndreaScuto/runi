...
- The v0.1 core is the released durable, verified, local single-worker supervisor. The next product target is v0.2: adaptive recovery plus a small Leo-branded supervision experience; keep it single-worker and CLI-first.
